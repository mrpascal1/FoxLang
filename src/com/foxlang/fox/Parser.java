...
class Parser {
    ...
    * */
    ...
    private Stmt whenStatement(){
        ...
        return new Stmt.When(condition, left, branch);
    }

    /*private Expr whenExpression() {
        consume(LEFT_PAREN, "Expected '(' after 'when'.");
        Expr condition = primary();
        consume(RIGHT_PAREN, "Expected ')' after argument.");
        Expr left = primary();
        consume(ARROW, "Expected '->' after condition");
        Expr branch = expression();
        return new Expr.When(condition, left, branch);
    }*/
    ...
    private Expr primary() {
        ...
        //if (match(WHEN)) return whenExpression();
